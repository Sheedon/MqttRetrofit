...
import org.sheedon.sample.databinding.FragmentRetrofitBinding
...
class RetrofitFragment : Fragment() {
    override fun onCreateView(
        ...
        val binding: FragmentRetrofitBinding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_retrofit, container, false)
